...
type Module = typeof import("../app.playbooks.$id.js")

type Info = GetInfo<{
  file: "routes/app.playbooks.$id.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.playbooks.js");
}, {
  id: "routes/app.playbooks.$id";
  module: typeof import("../app.playbooks.$id.js");
}];
